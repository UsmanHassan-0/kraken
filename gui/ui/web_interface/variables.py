...
# GUI root (e.g., .../kraken/gui)
root_path = os.path.dirname(os.path.dirname(current_path))
shared_path = os.path.join(root_path, "share")
...
daq_subsystem_path = os.path.join(os.path.join(os.path.dirname(root_path), "daq"), "Firmware")

daq_config_filename = os.path.join(daq_subsystem_path, "daq_chain_config.ini")

# Import Kraken SDR modules
receiver_path = os.path.join(root_path, "sdr/receiver")
signal_processor_path = os.path.join(root_path, "sdr/signal_processing")
...
daq_preconfigs_path = os.path.join(os.path.join(os.path.dirname(root_path), "daq"), "config_files")
daq_config_filename = os.path.join(daq_subsystem_path, "daq_chain_config.ini")
