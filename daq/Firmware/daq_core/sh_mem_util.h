...
#define GEN_FRAME_FW_FIFO "data_control/fw_ctr_gen_frame"
#define GEN_FRAME_BW_FIFO "data_control/bw_ctr_gen_frame"

#define DECIMATOR_IN_SM_NAME_A "decimator_in_A"
#define DECIMATOR_IN_SM_NAME_B "decimator_in_B"
#define DECIMATOR_IN_FW_FIFO "data_control/fw_decimator_in"
#define DECIMATOR_IN_BW_FIFO "data_control/bw_decimator_in"
        
#define DECIMATOR_OUT_SM_NAME_A "decimator_out_A"
#define DECIMATOR_OUT_SM_NAME_B "decimator_out_B"
#define DECIMATOR_OUT_FW_FIFO "data_control/fw_decimator_out"
#define DECIMATOR_OUT_BW_FIFO "data_control/bw_decimator_out"

#define DELAY_SYNC_IQ_SM_NAME_A "delay_sync_iq_A"
#define DELAY_SYNC_IQ_SM_NAME_B "delay_sync_iq_B"
#define DELAY_SYNC_IQ_FW_FIFO "data_control/fw_delay_sync_iq"
#define DELAY_SYNC_IQ_BW_FIFO "data_control/bw_delay_sync_iq"
