...
"""
	...
	FIR filter at : "logs/Decimator_filter_transfer.html"
...
transfer_fname = "logs/Decimator_filter_transfer.html"
coeffs_fname = "data_control/fir_coeffs.txt"
# Ensure output directories exist
os.makedirs(os.path.dirname(coeffs_fname), exist_ok=True)
os.makedirs(os.path.dirname(transfer_fname), exist_ok=True)
